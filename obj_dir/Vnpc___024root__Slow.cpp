...
void Vnpc___024unit____Vdpiimwrap_set_gpr_ptr__Vdpioc2_TOP____024unit(const VlUnpacked<QData/*63:0*/, 32> &a);

void Vnpc___024root___initial__TOP__2(Vnpc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnpc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnpc___024root___initial__TOP__2\n"); );
    // Body
    vlSelf->npc__DOT__ifu1__DOT__pc_cnt = 0x80000000ULL;
    Vnpc___024unit____Vdpiimwrap_set_gpr_ptr__Vdpioc2_TOP____024unit(vlSelf->npc__DOT__reg1__DOT__regs);
}
...
void Vnpc___024root___settle__TOP__3(Vnpc___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vnpc__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vnpc___024root___settle__TOP__3\n"); );
    // Variables
...
void Vnpc___024root___eval_initial(Vnpc___024root* vlSelf) {
    ...
    Vnpc___024root___initial__TOP__2(vlSelf);
}
...
void Vnpc___024root___eval_settle(Vnpc___024root* vlSelf) {
    ...
    // Body
    Vnpc___024root___settle__TOP__3(vlSelf);
}
...
void Vnpc___024root___ctor_var_reset(Vnpc___024root* vlSelf) {
    ...
    vlSelf->npc__DOT__rs1_addr_id_o = VL_RAND_RESET_I(5);
    vlSelf->npc__DOT__rs2_addr_id_o = VL_RAND_RESET_I(5);
    vlSelf->npc__DOT__op1_o = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__op2_o = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__op3_o = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__op1_jump = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__op2_jump = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__inst_type_o = VL_RAND_RESET_I(7);
    vlSelf->npc__DOT__inst_funct3_o = VL_RAND_RESET_I(3);
    vlSelf->npc__DOT__inst_funct7_o = VL_RAND_RESET_I(7);
    vlSelf->npc__DOT__reg_waddr_id_o = VL_RAND_RESET_I(5);
    vlSelf->npc__DOT__reg_we_id_o = VL_RAND_RESET_I(1);
    vlSelf->npc__DOT__break_en = VL_RAND_RESET_I(1);
    vlSelf->npc__DOT__reg_we_ex_o = VL_RAND_RESET_I(1);
    vlSelf->npc__DOT__reg_waddr_ex_o = VL_RAND_RESET_I(5);
    vlSelf->npc__DOT__jump_flag = VL_RAND_RESET_I(1);
    vlSelf->npc__DOT__jump_addr = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__reg_wdata_ex_o = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__ifu1__DOT__pc_cnt = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__exu1__DOT__mem_wen = VL_RAND_RESET_I(1);
    vlSelf->npc__DOT__exu1__DOT__mask = VL_RAND_RESET_I(8);
    vlSelf->npc__DOT__exu1__DOT__mem_wdata = VL_RAND_RESET_Q(64);
    vlSelf->npc__DOT__exu1__DOT__mem_waddr = VL_RAND_RESET_Q(64);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->npc__DOT__reg1__DOT__regs[__Vi0] = VL_RAND_RESET_Q(64);
    }
    vlSelf->__Vtask_pmem_read__0__rdata = 0;
    vlSelf->__Vtask_pmem_read_l__49__rdata = 0;
    vlSelf->__Vtask_pmem_read_l__50__rdata = 0;
    vlSelf->__Vtask_pmem_read_l__51__rdata = 0;
    vlSelf->__Vtask_pmem_read_l__52__rdata = 0;
    vlSelf->__Vtask_pmem_read_l__53__rdata = 0;
    vlSelf->__Vchglast__TOP__npc__DOT__rs1_addr_id_o = VL_RAND_RESET_I(5);
    vlSelf->__Vchglast__TOP__npc__DOT__rs2_addr_id_o = VL_RAND_RESET_I(5);
}
